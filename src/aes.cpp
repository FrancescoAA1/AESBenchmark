...
constexpr std::array<Byte, S_BOX_SIZE> AES::S_BOX = {
...
constexpr std::array<Byte, S_BOX_SIZE> AES::INV_S_BOX = {
...
constexpr std::array<std::array<Byte, KEY_WORDS>, NUM_ROUNDS> AES::RCON = {{{0x01, 0x00, 0x00, 0x00},
                                                                            {0x02, 0x00, 0x00, 0x00},
                                                                            {0x04, 0x00, 0x00, 0x00},
                                                                            {0x08, 0x00, 0x00, 0x00},
                                                                            {0x10, 0x00, 0x00, 0x00},
...
constexpr std::array<std::array<Byte, N_COLS>, N_ROWS> AES::MIX_COL_MATRIX = {{{0x02, 0x03, 0x01, 0x01},
                                                                               {0x01, 0x02, 0x03, 0x01},
                                                                               {0x01, 0x01, 0x02, 0x03},
                                                                               {0x03, 0x01, 0x01, 0x02}}};
...
constexpr std::array<std::array<Byte, N_COLS>, N_ROWS> AES::MIX_COL_MATRIX_INV = {{{0x0e, 0x0b, 0x0d, 0x09},
                                                                                   {0x09, 0x0e, 0x0b, 0x0d},
                                                                                   {0x0d, 0x09, 0x0e, 0x0b},
                                                                                   {0x0b, 0x0d, 0x09, 0x0e}}};
...
// The mix col matrix in the AES class contains the coefficients of this polynomial
